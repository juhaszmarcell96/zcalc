...
export class CJunctionBox extends IComponent {
    constructor (x, y) {
        ...
        this.terminals = {
            T1: new CTerminal(this, -this.w / 2 + 15 * scale, -this.h / 2 + 15 * scale, Colors.l3),
            T2: new CTerminal(this, -this.w / 2 + 35 * scale, -this.h / 2 + 35 * scale, Colors.l3),
            T3: new CTerminal(this, -this.w / 2 + 55 * scale, -this.h / 2 + 55 * scale, Colors.l3)
        }
    }
