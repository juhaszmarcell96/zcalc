class CSwitch101 extends IComponent {
    ...
    draw (context, zoom) {
        ...
        if (this.closed == false) {
            ...
            context.moveTo(zoomed_x +  5 * zoomed_g, zoomed_y + 8 * zoomed_g);
            context.lineTo(zoomed_x + 11 * zoomed_g, zoomed_y + 8 * zoomed_g);
        }
        context.moveTo(zoomed_x + 11 * zoomed_g, zoomed_y + 8 * zoomed_g);
        context.lineTo(zoomed_x + 16 * zoomed_g, zoomed_y + 8 * zoomed_g);
