class CSwitch106 extends IComponent {
    constructor (x, y) {
        ...
        this.terminals = {
            T1: new CTerminal(-this.w / 2          - 10 * scale, -this.h / 2 + 50 * scale, Colors.l3),
            T2: new CTerminal(-this.w / 2 + this.w + 10 * scale, -this.h / 2 + 30 * scale, Colors.l3),
            T3: new CTerminal(-this.w / 2 + this.w + 10 * scale, -this.h / 2 + 70 * scale, Colors.l3)
        }
        this.closed = false;
    }
